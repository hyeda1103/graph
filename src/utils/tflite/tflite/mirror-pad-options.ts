...
import { MirrorPadMode } from "@/utils/tflite/tflite/mirror-pad-mode";
...
export class MirrorPadOptions {
  ...
  static getRootAsMirrorPadOptions(
    bb: flatbuffers.ByteBuffer,
    obj?: MirrorPadOptions,
  ): MirrorPadOptions {
    return (obj || new MirrorPadOptions()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
  }

  static getSizePrefixedRootAsMirrorPadOptions(
    bb: flatbuffers.ByteBuffer,
    obj?: MirrorPadOptions,
  ): MirrorPadOptions {

...
export class StablehloTransposeOptions {
  ...
  static getRootAsStablehloTransposeOptions(
    bb: flatbuffers.ByteBuffer,
    obj?: StablehloTransposeOptions,
  ): StablehloTransposeOptions {
    return (obj || new StablehloTransposeOptions()).__init(
      bb.readInt32(bb.position()) + bb.position(),
      bb,
    );
  }

  static getSizePrefixedRootAsStablehloTransposeOptions(
    bb: flatbuffers.ByteBuffer,
    obj?: StablehloTransposeOptions,
  ): StablehloTransposeOptions {
  ...
  static createStablehloTransposeOptions(
    builder: flatbuffers.Builder,
    permutationOffset: flatbuffers.Offset,
  ): flatbuffers.Offset {

...
export class CustomQuantization {
  ...
  static getRootAsCustomQuantization(
    bb: flatbuffers.ByteBuffer,
    obj?: CustomQuantization,
  ): CustomQuantization {
    return (obj || new CustomQuantization()).__init(
  ...
  static createCustomQuantization(
    builder: flatbuffers.Builder,
    customOffset: flatbuffers.Offset,
  ): flatbuffers.Offset {

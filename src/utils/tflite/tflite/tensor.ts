...
import { QuantizationParameters } from "@/utils/tflite/tflite/quantization-parameters";
import { SparsityParameters } from "@/utils/tflite/tflite/sparsity-parameters";
import { TensorType } from "@/utils/tflite/tflite/tensor-type";
import { VariantSubType } from "@/utils/tflite/tflite/variant-sub-type";
...
export class Tensor {
  ...
  quantization(obj?: QuantizationParameters): QuantizationParameters | null {
    ...
    return offset
      ? (obj || new QuantizationParameters()).__init(
  ...
  sparsity(obj?: SparsityParameters): SparsityParameters | null {
    ...
    return offset
      ? (obj || new SparsityParameters()).__init(
          this.bb!.__indirect(this.bb_pos + offset),
          this.bb!,
        )
      : null;
  ...
  static addVariantTensors(builder: flatbuffers.Builder, variantTensorsOffset: flatbuffers.Offset) {
  ...
  static startVariantTensorsVector(builder: flatbuffers.Builder, numElems: number) {
    builder.startVector(4, numElems, 4);
  }

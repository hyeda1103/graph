...
import { TensorMap } from "@/utils/tflite/tflite/tensor-map";
...
export class SignatureDef {
  ...
  static getSizePrefixedRootAsSignatureDef(
  ...
  static createSignatureDef(
    ...
    signatureKeyOffset: flatbuffers.Offset,
    subgraphIndex: number,
  ): flatbuffers.Offset {

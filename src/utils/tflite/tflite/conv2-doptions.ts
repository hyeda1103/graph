...
export class Conv2DOptions {
  ...
  static getSizePrefixedRootAsConv2DOptions(
  ...
  static addQuantizedBiasType(builder: flatbuffers.Builder, quantizedBiasType: TensorType) {
    builder.addFieldInt8(6, quantizedBiasType, TensorType.FLOAT32);
  }
  ...
  static createConv2DOptions(
    ...
    Conv2DOptions.addQuantizedBiasType(builder, quantizedBiasType);

...
import {
  QuantizationDetails,
  unionToQuantizationDetails,
  unionListToQuantizationDetails,
} from "@/utils/tflite/tflite/quantization-details";
...
export class QuantizationParameters {
  ...
  static getRootAsQuantizationParameters(
    bb: flatbuffers.ByteBuffer,
    obj?: QuantizationParameters,
  ): QuantizationParameters {
    return (obj || new QuantizationParameters()).__init(
  ...
  static createQuantizationParameters(
    builder: flatbuffers.Builder,
    minOffset: flatbuffers.Offset,
    maxOffset: flatbuffers.Offset,
    scaleOffset: flatbuffers.Offset,
    zeroPointOffset: flatbuffers.Offset,
    detailsType: QuantizationDetails,
    detailsOffset: flatbuffers.Offset,
    quantizedDimension: number,
  ): flatbuffers.Offset {

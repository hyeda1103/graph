...
import { CombinerType } from "@/utils/tflite/tflite/combiner-type";
...
export class EmbeddingLookupSparseOptions {
  ...
  static getRootAsEmbeddingLookupSparseOptions(
    ...
    obj?: EmbeddingLookupSparseOptions,
  ): EmbeddingLookupSparseOptions {
    return (obj || new EmbeddingLookupSparseOptions()).__init(
  ...
  static createEmbeddingLookupSparseOptions(

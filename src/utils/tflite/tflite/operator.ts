...
import {
  BuiltinOptions,
  unionToBuiltinOptions,
  unionListToBuiltinOptions,
} from "@/utils/tflite/tflite/builtin-options";
import {
  BuiltinOptions2,
  unionToBuiltinOptions2,
  unionListToBuiltinOptions2,
} from "@/utils/tflite/tflite/builtin-options2";
import { CustomOptionsFormat } from "@/utils/tflite/tflite/custom-options-format";
...
export class Operator {
  ...
  static createCustomOptionsVector(
    builder: flatbuffers.Builder,
    data: number[] | Uint8Array,
  ): flatbuffers.Offset {
  ...
  static addMutatingVariableInputs(
    builder: flatbuffers.Builder,
    mutatingVariableInputsOffset: flatbuffers.Offset,
  ) {
    builder.addFieldOffset(7, mutatingVariableInputsOffset, 0);
  }

  static createMutatingVariableInputsVector(
    builder: flatbuffers.Builder,
    data: boolean[],
  ): flatbuffers.Offset {
    builder.startVector(1, data.length, 1);
  ...
  static addLargeCustomOptionsOffset(
    builder: flatbuffers.Builder,
    largeCustomOptionsOffset: bigint,
  ) {
  ...
  static addBuiltinOptions2(
    builder: flatbuffers.Builder,
    builtinOptions2Offset: flatbuffers.Offset,
  ) {
  ...
  static createOperator(
    ...
    builtinOptionsType: BuiltinOptions,
    builtinOptionsOffset: flatbuffers.Offset,
    customOptionsOffset: flatbuffers.Offset,
    customOptionsFormat: CustomOptionsFormat,
    mutatingVariableInputsOffset: flatbuffers.Offset,
    intermediatesOffset: flatbuffers.Offset,
    largeCustomOptionsOffset: bigint,
    largeCustomOptionsSize: bigint,
    builtinOptions2Type: BuiltinOptions2,
    builtinOptions2Offset: flatbuffers.Offset,

...
import { FullyConnectedOptionsWeightsFormat } from "@/utils/tflite/tflite/fully-connected-options-weights-format";
...
export class FullyConnectedOptions {
  ...
  static getRootAsFullyConnectedOptions(
    bb: flatbuffers.ByteBuffer,
    obj?: FullyConnectedOptions,
  ): FullyConnectedOptions {
    return (obj || new FullyConnectedOptions()).__init(

...
import { Buffer } from "@/utils/tflite/tflite/buffer";
import { Metadata } from "@/utils/tflite/tflite/metadata";
import { OperatorCode } from "@/utils/tflite/tflite/operator-code";
import { SignatureDef } from "@/utils/tflite/tflite/signature-def";
import { SubGraph } from "@/utils/tflite/tflite/sub-graph";
...
export class Model {
  ...
  static createOperatorCodesVector(
  ...
  static createSignatureDefsVector(
    builder: flatbuffers.Builder,
    data: flatbuffers.Offset[],
  ): flatbuffers.Offset {
    builder.startVector(4, data.length, 4);
  ...
  static createModel(
    builder: flatbuffers.Builder,
    version: number,
    operatorCodesOffset: flatbuffers.Offset,
    subgraphsOffset: flatbuffers.Offset,
    descriptionOffset: flatbuffers.Offset,
    buffersOffset: flatbuffers.Offset,
    metadataBufferOffset: flatbuffers.Offset,
    metadataOffset: flatbuffers.Offset,
    signatureDefsOffset: flatbuffers.Offset,
  ): flatbuffers.Offset {

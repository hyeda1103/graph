...
import { DimensionType } from "@/utils/tflite/tflite/dimension-type";
import {
  SparseIndexVector,
  unionListToSparseIndexVector,
  unionToSparseIndexVector,
} from "@/utils/tflite/tflite/sparse-index-vector";
...
export class DimensionMetadata {
  ...
  static getRootAsDimensionMetadata(
  ...
  static createDimensionMetadata(
    ...
    denseSize: number,
    arraySegmentsType: SparseIndexVector,
    arraySegmentsOffset: flatbuffers.Offset,
    arrayIndicesType: SparseIndexVector,
    arrayIndicesOffset: flatbuffers.Offset,
  ): flatbuffers.Offset {
